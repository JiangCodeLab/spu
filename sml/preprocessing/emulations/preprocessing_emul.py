...
def emul_brier_score_loss():
    ...
    spu_brier_score_loss = spsim.sim_jax(sim_aby, brier_score_loss_jax)
    ...
    #print(f"SPU : {loss_jax_spu}")
    
    # 计算 sklearn 版本 Brier Score Loss 作为基准
    loss_sklearn = brier_score_loss(y_true_numeric, y_proba, pos_label=pos_label_numeric)
    #print(f"Sklearn : {loss_sklearn}")
